...
def get_config():
    ...
    """
    config = dict()
    data_yaml = check_yaml("./qrcode_dataset/data.yaml")
    data = check_dataset(data_yaml)

    model_config = {
        "model_name": "yolov5s",
        "model": "./weights/yolov5s-640.xml",
        "weights": "./weights/yolov5s-640.bin"
    }
...
save_dir = increment_path("./weights/yolov5s_openvino_model/", exist_ok=True)  # increment run
